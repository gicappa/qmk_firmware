...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   /* Qwerty
     ...
     * |-----------------------------------------------------------------------------------------+
     * | Ctrl |  Alt  |  Cmd  |                 Space                | Cmd  | RAlt |RCtrl |MO(1) |
     * `-----------------------------------------------------------------------------------------'
     */
	LAYOUT_60_ansi(
		KC_GESC, KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, KC_EQL,  KC_BSPC,
		KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, KC_BSLS,
		KC_CAPS, LT2_A,   LCTL_S,  LALT_D,  LSFT_F,  KC_G,    KC_H,    RSFT_J,  RALT_K,  RCTL_L,  KC_SCLN, KC_QUOT, KC_ENT,
	...
	LAYOUT_60_ansi(
		...
		_______, _______, _______, _______, _______, _______, _______, KC_PGDN, KC_INS,  KC_PGUP, _______,          _______,
		_______, _______, _______,                   _______,                            _______, _______, _______, _______
    )
};
