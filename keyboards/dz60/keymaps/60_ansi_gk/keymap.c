...
#define _V MT(MOD_LGUI, KC_V)
#define _M MT(MOD_RGUI, KC_M)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * |----------------------------------------------------------------------------------------------------+
     * | Shift     |   Z  |   X  |   C  | V\Cmd|   B  |   N  |M\RCmd|   ,  |   .  |   /  |      RShift      |
     * |----------------------------------------------------------------------------------------------------+
     * | Ctrl  |   Alt  |   Cmd  |             Space^FNKC                  |  Cmd  |  RAlt | RCtrl | Fn^MISC|
     * `----------------------------------------------------------------------------------------------------'
     */
	LAYOUT_60_ansi(
		...
		KC_LSFT, KC_Z,    KC_X,    KC_C,    _V,    KC_B,    KC_N,    _M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
		KC_LCTL, KC_LALT, KC_LGUI,                   _L1_SPC,                            KC_RGUI, KC_RALT, KC_RCTL, _L3_FN
    ),
