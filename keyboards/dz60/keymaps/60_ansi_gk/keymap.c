...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   /* Functions
	...
	LAYOUT_60_ansi(
		...
		_______, _______, _______, _______, _______, _______, _______, KC_LBRC, KC_RBRC, _______, _______, _______, _______, RESET,
		_______, _______, _______, KC_BSLS, KC_PIPE, _______, _______, KC_LPRN, KC_RPRN, _______, _______, _______, _______,
